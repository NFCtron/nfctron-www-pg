...
export async function generateMetadata({ params }: { params: LocaleParams }): Promise<Metadata> {
  return createArtistMetadata(artistProfiles.likeIt, await getRouteLocale(params));
}

export default async function LikeItPage({ params }: { params: LocaleParams }) {
  return <ArtistProfile locale={await getRouteLocale(params)} profile={artistProfiles.likeIt} />;
}
