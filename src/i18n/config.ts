...
const en: Record<string, string> = {
  'Domů': 'Home', 'Akce': 'Events', 'Jak to funguje': 'How it works', 'Pro pořadatele': 'For organizers', 'Přihlásit se': 'Sign in',
  ...
  'Festival plný hudby a zážitků': 'A festival full of music and experiences', 'Objevte akci v NFCtron Tickets': 'Discover the event in NFCtron Tickets',
